...
const LandingPage = ({ onSystemInitialize }) => {
    ...
    return (
        <div className="w-full relative z-10 scroll-smooth pointer-events-none">
            ...
            {/* SECTION 3: PLATFORM OVERVIEW with GALAXY */}
            <Element name="overview" className="min-h-[80vh] w-full bg-black relative z-20 py-16 md:py-32 flex flex-col items-center justify-center border-t border-white/10 pointer-events-auto overflow-hidden">
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 container mx-auto px-6 md:px-12">
                    {/* Node 1 */}
                    <Link to="/intelligence" className="block p-10 border border-white/10 rounded-3xl bg-black/40 backdrop-blur-md hover:bg-white/10 transition-all group hover:scale-105 duration-300">
                    ...
                    {/* Node 2 */}
                    <Link to="/analytics" className="block p-10 border border-crisis-red/30 rounded-3xl bg-black/40 backdrop-blur-md relative overflow-hidden group hover:scale-105 duration-300">
                    ...
                    {/* Node 3 */}
                    <Link to="/coordination" className="block p-10 border border-white/10 rounded-3xl bg-black/40 backdrop-blur-md hover:bg-white/10 transition-all group hover:scale-105 duration-300">
            ...
            <footer className="w-full py-12 bg-black border-t border-white/10 relative z-20 pointer-events-auto">
                <div className="container mx-auto px-8 flex flex-col md:flex-row justify-between items-end gap-6">
                    <div>
                        <div className="text-2xl font-bold tracking-wider text-white mb-2">SANKAT<span className="text-crisis-red">SAATHI</span></div>
                        <div className="text-gray-500 text-xs max-w-xs mb-4">
